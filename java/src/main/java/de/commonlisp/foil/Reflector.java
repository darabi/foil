...
public class Reflector implements IReflector {
        ...
        if (params.length == args.size()) {
            ...
            for (int i = 0; ret && i < params.length; i++) {
                ...
                if (paramType == boolean.class) {
                    ...
                    ret = arg == null || argType == paramType || paramType.isAssignableFrom(argType);
                }
            }
        }
        return ret;
    ...
    public void members(Class<?> c, Writer w) throws Exception {
        ...
        if (methods.length > 0) {
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if ((method.getDeclaringClass() != c)
                        || (!Modifier.isStatic(method.getModifiers()) && (method.getName().equals("toString")
                                || method.getName().equals("equals") || method.getName().equals("hashCode"))) && c != Object.class)
                    continue;
                w.write('(');
        ...
        if (props.length > 0) {
            ...
            for (int i = 0; i < props.length; i++) {
                ...
                if (prop instanceof IndexedPropertyDescriptor || readm == null || readm.getDeclaringClass() != c
     ...
     * (non-Javadoc)
     * 
     * @see de.commonlisp.foil.IReflector#vectorGet(java.lang.Object, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see de.commonlisp.foil.IReflector#vectorSet(java.lang.Object, int, java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see de.commonlisp.foil.IReflector#vectorLength(java.lang.Object)
     */
    ...
    void setProp(Object o, PropertyDescriptor[] props, String name, Object value) throws Exception {
        for (int i = 0; i < props.length; i++) {
            PropertyDescriptor prop = props[i];
            // only support keyword-style init of non-indexed props
            if (!(prop instanceof IndexedPropertyDescriptor) && prop.getName().equalsIgnoreCase(name)) {
